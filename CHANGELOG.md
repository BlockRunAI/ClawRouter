...
- New deps: `@polymarket/clob-client-v2@1.0.8`, `@polymarket/builder-relayer-client`, `@polymarket/builder-signing-sdk`, `axios`, `https-proxy-agent`, `@blockrun/llm` (for the gasless funding path). `@solana/kit` stayed deduped at V6.5.1 (no version split).
