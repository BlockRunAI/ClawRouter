...
ClawRouter maintains a curated catalog of <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models across 9 providers (including <!-- br:models.free -->6<!-- /br:models.free --> free models), updated with each release. Delisted models have automatic redirect aliases:
...
| **Model catalog**   | Laggy, silent drops              | Curated <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models, redirect aliases         |
