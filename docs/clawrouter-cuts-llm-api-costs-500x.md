...
<p align="center"><img src="assets/blockrun-clawrouter-x402-usdc-micropayment-wallet-budget-control.png" alt="Budget limits enforced by physical construction — wallet loaded via Base/Solana, pay per call across <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> models, balance hits zero and the valve shuts cleanly" width="720"></p>
...
```
<!-- br:models.chatVisible@live -->79<!-- /br:models.chatVisible@live --> models. One wallet. Pay per call.
```
